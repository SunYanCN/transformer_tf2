...
encoder layer structure:
                    [x, enc_padding_mask]
                             v
    [multi-head attention + dropout + layer-normalisation ]
                             v
    [point wise feed forward + dropout + layer-normalisation ] > x
'''
...
decoder layer structure:
        [x, enc_output, look_ahead_mask, padding_mask]
                             v
    [multi-head attention + dropout + layer-normalisation ] > attn_weights_block1
                             v
    [multi-head attention + dropout + layer-normalisation ] > attn_weights_block2 
                             v           
    [point wise feed forward + dropout + layer-normalisation ] > x
'''
...
Encoder Block:
    ...
    [dropout]
            v
    [encoder layer for each layer] > enc_output
'''
...
class Encoder(keras.layers.Layer):
    def __init__(self, num_layers, d_model, num_heads, dff, input_vocab_size, rate = 0.1):
        ...
        self.pos_encoding = PositionalEncoder(position = input_vocab_size,
                                              d_model = self.d_model).positional_encoding()
...
Decoder Block:
    ...
    [dropout]
            v
    [decoder layer for each layer] > x, attention_weights
'''
...
class Decoder(keras.layers.Layer):
    def __init__(self, num_layers, d_model, num_heads, dff, target_vocab_size, rate = 0.1):
        ...
        self.pos_encoding = PositionalEncoder(position = target_vocab_size,
                                              d_model = self.d_model).positional_encoding()
...
transformer structure 
    ...
    [decoder block]
          v
    [dense layer] > final_output, attention_weights
'''
...
if __name__ == '__main__':
    ...
    # ************************************
    sample_ffn = Encoder.point_wise_feed_forward_network(512, 2048)
